  ...
  const BookCard = ({ book }: { book: Book }) => (
    ...
    >
      <View style={styles.bookImageContainer}>
        <Image 
          source={{ uri: book.coverImage.startsWith('http') ? book.coverImage : `http://192.168.1.6:3000${book.coverImage}` }} 
      ...
      <View style={styles.bookInfo}>
        ...
        <View style={styles.sellerInfo}>
          <Image 
            source={{ uri: book.seller.image?.startsWith('http') ? book.seller.image : `http://192.168.1.6:3000${book.seller.image}` || 'https://via.placeholder.com/24' }} 
